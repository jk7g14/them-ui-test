    ...
    return (
      ...
      >
        <Flex sx={{ height: 120, justifyContent: "space-between" }}>
          <Flex sx={{ color: "white", alignItems: "center", ml: "30px" }}>
          ...
          >
            <Text height="100%" sx={{ color: "white" }}>
              ONSENLING
            </Text>
          </Flex>
          <Flex sx={{ alignItems: "center", mr: "30px", color: "white" }}>
            <Text>로그인</Text>
            <FontAwesomeIcon
              icon={faShoppingBag}
  ...
  const BoxForFourBanner = () => {
    return (
      <Box style={{ position: "relative" }}>
        ...
        >
          <Box as="span" sx={{ color: "white", fontSize: "15px" }}>
            HOT
          </Box>
        </Flex>
      </Box>
